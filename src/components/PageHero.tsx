    ...
    <section className="relative bg-[var(--color-navy)] pt-16 pb-16 lg:pt-20 lg:pb-24 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="text-lg text-white/50 max-w-2xl leading-relaxed mb-6">{description}</p>
          {showCTA && (
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 rounded-xl border border-white/20 px-6 py-3 text-sm font-semibold text-white/80 hover:bg-white/5 transition-all"
              >
