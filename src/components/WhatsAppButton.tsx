...
export default function WhatsAppButton() {
  return (
    <motion.a
      ...
      /* Entry: bounce in from bottom-right after 3s delay */
      ...
      whileTap={{ scale: 0.95 }}
    >
      {/* Pulsing ring for attention every 5 seconds */}
      <motion.span
        ...
        transition={{
          ...
          repeatDelay: 5,
          ease: "easeOut",
          delay: 4.5, // starts after entry animation
        }}
        aria-hidden="true"
      />
      ...
      {/* Notification dot */}
      <motion.span
        className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 rounded-full bg-[var(--color-amber)] border-2 border-white z-10"
        animate={{
          scale: [1, 1.3, 1],
          opacity: [1, 0.8, 1],
        }}
