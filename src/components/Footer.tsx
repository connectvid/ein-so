        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-10 mb-16">
          ...
          <div className="col-span-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[#25D366] px-4 py-2.5 text-sm font-bold text-white hover:bg-[#20bd5a] transition-all hover:-translate-y-0.5"
            >
          ...
          {columns.map((col) => (
            <div key={col.title}>
              <h4 className="text-xs font-bold uppercase tracking-widest text-[var(--color-blue-glow)] mb-4">
                {col.title}
              </h4>
