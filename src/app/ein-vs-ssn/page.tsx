...
export const metadata: Metadata = {
  ...
  description:
    "EIN vs SSN: An EIN identifies your business; an SSN identifies you as an individual. Learn the key differences, when you need each, and how non-residents can get an EIN without an SSN.",
  alternates: { canonical: "/ein-vs-ssn/" },
};
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "EIN vs SSN", url: "/ein-vs-ssn/" },
        ]}
      />
      <ArticleSchema
