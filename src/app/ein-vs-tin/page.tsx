...
export const metadata: Metadata = {
  ...
  description:
    "TIN (Taxpayer Identification Number) is the general term. EIN, SSN, and ITIN are all types of TINs. Learn which one your business needs.",
  alternates: { canonical: "/ein-vs-tin/" },
};
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "EIN vs TIN", url: "/ein-vs-tin/" },
        ]}
      />
      <ArticleSchema
