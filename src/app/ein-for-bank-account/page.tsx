...
export const metadata: Metadata = {
  ...
  description:
    "You need an EIN to open a US business bank account. Learn which banks work for non-residents, what documents you need, and how to open an account remotely in 2026.",
  alternates: { canonical: "/ein-for-bank-account/" },
};
    ...
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "EIN for Bank Account", url: "/ein-for-bank-account/" },
        ]}
      />
      <ArticleSchema
      ...
      />
      <FAQSchema faqs={faqs} />
      <EinForBankAccountClient faqs={faqs} />
    </>
  );
}
