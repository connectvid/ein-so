          ...
          <AnimateIn>
            <div className="max-w-3xl mx-auto">
              ...
              <p className="text-[var(--color-text-muted)] leading-relaxed">
                If you prefer to skip the paperwork entirely, <Link href="/apply/" className="text-[var(--color-blue)] underline">ein.so handles the entire SS-4 filing process</Link> for $49 (Standard, 5-7 business days) or $97 (Express, 2-3 business days). We complete the form, fax it to the IRS, and deliver your EIN by email. For those who want to do it themselves, read on for the complete line-by-line breakdown. You can also review our broader <Link href="/how-to-get-ein/" className="text-[var(--color-blue)] underline">How to Get an EIN</Link> guide for all three application methods.
              </p>
            </div>
          </AnimateIn>
        </div>
