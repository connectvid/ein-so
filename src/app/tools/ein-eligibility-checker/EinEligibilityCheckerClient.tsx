        ...
        <div className="mx-auto max-w-7xl px-6">
          <AnimateIn className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <p className="text-[var(--color-text-muted)] leading-relaxed">
                The ein.so service exists specifically to solve this problem. We complete and file Form SS-4 on your behalf, submit it to the IRS by fax, and deliver your EIN by email. Our Standard service costs $49 with a 5-7 business day turnaround, while our Express service costs $97 with a 2-3 business day turnaround. Both options include full support via WhatsApp throughout the process. Visit our <Link href="/how-to-get-ein/" className="text-[var(--color-blue)] underline">How to Get an EIN</Link> page for a detailed walkthrough of the entire application process.
              </p>
            </div>
          </AnimateIn>
        </div>
