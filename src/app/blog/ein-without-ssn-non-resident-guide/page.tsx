...
const { frontmatter: fm, content } = getListPage("blog/ein-without-ssn-non-resident-guide/_index.md");
...
export default function BlogEinWithoutSsnNonResidentGuidePage() {
  return (
    <>
