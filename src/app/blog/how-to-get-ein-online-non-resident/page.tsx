...
const { frontmatter: fm, content } = getListPage("blog/how-to-get-ein-online-non-resident/_index.md");
...
export default function BlogHowToGetEinOnlineNonResidentPage() {
  return (
    <>
