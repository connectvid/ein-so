...
import EinForRealEstateInvestorsClient from "./EinForRealEstateInvestorsClient";

export const metadata: Metadata = {
  title: "EIN for Real Estate Investors: LLC & FIRPTA Guide (2026)",
  description:
    "Real estate investors need an EIN for their LLC, rental income reporting, and FIRPTA compliance. Non-resident investors: apply by fax.",
  alternates: { canonical: "/ein-for-real-estate-investors/" },
};
...
export default function EinForRealEstateInvestorsPage() {
  return (
    <>
      <BreadcrumbSchema
        items={[
          ...
          { name: "EIN for Real Estate Investors", url: "/ein-for-real-estate-investors/" },
        ]}
      />
      <ArticleSchema
      ...
      />
      <FAQSchema faqs={faqs} />
      <EinForRealEstateInvestorsClient faqs={faqs} />
    </>
  );
}
