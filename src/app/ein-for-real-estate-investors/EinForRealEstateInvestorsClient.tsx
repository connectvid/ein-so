            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { structure: "Non-Resident Investor (Form 1040-NR)", detail: "Non-US investors report US rental income on Form 1040-NR using their EIN. Rental income is generally taxed at graduated rates if you make a Section 871(d) election, which allows you to deduct expenses. Without this election, rental income is taxed at a flat 30%." },
                ].map((item, idx) => (
