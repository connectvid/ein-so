            ...
            <div className="space-y-6">
              ...
              <StaggerContainer className="space-y-4">
                {[
                  ...
                  { title: "Wise and Alternative Transfer Services", desc: "Wise supports CNY/USD transfers, though availability and limits may vary. Some Chinese entrepreneurs use Hong Kong bank accounts as intermediaries between their US and Chinese banking. Your EIN-linked US bank account is the US anchor for these transfers." },
                ].map((item, idx) => (
                  <StaggerItem key={idx}>
