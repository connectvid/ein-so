          ...
          <AnimateIn className="max-w-3xl mx-auto">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[var(--color-surface)] rounded-2xl border border-[var(--color-border)] p-6">
                <StaggerContainer className="space-y-4">
                  {[
                    { step: "1", title: "Form a US LLC", desc: "Form an LLC in Wyoming, Delaware, or New Mexico through a registered agent. This is done entirely online from Bangladesh. Most Bangladeshi entrepreneurs choose Wyoming for its low costs and strong privacy protections. Formation costs $100-300 plus state fees." },
