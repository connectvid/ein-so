...
heroDescription: "Apply for your US EIN from Iran without an SSN or ITIN. ein.so handles the IRS fax filing process for Iranian freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Iranian citizens get a US EIN?"
    a: "Yes. Iranian citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Iran passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Iran?"
    a: "No. Iranian applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Iran?"
  ...
  - q: "Can I open a US bank account from Iran?"
  ...
  - q: "What is the EIN equivalent in Iran?"
    a: "The Iran equivalent of a US EIN is the Economic Code (12 digits), issued by INTA. Your Economic Code has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Iranian entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Iran passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Iran</Label>

## Iran's <Accent>US Business Footprint</Accent>

Iran has a population of 87,000,000 and a GDP of $368B. Note: US sanctions may restrict some services. Iranian entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Iran | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | Economic Code (12 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | INTA | IRS |
| Currency | Iranian Rial (IRR, ~0.000024 USD) | USD |
| Population | 87,000,000 | 330M+ |

### Why Iranian Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Iran</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Iran passport number on Line 7b (where it asks for SSN). Use your Iran address on Line 4.</ProcessStep>
...
### Next Steps for Iranian Entrepreneurs
...
- Your US LLC income may be subject to both US and Iran taxes
- Check if a US-Iran tax treaty exists for reduced withholding
- Consult a CPA experienced with Iranian entrepreneurs in the US
...
[Apply for your EIN from Iran — $49](/apply/)
</Section>
