...
description: "Japanese entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Japan using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Japan without an SSN or ITIN. ein.so handles the IRS fax filing process for Japanese freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Japanese citizens get a US EIN?"
    a: "Yes. Japanese citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Japan passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Japan?"
    a: "No. Japanese applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Japan?"
  ...
  - q: "Can I open a US bank account from Japan?"
  ...
  - q: "What is the EIN equivalent in Japan?"
    a: "The Japan equivalent of a US EIN is the My Number (12 digits), issued by National Tax Agency. Your My Number has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Japanese entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Japan passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Japan</Label>

## Japan's <Accent>US Business Footprint</Accent>

Japan has a population of 125,000,000 and a GDP of $4.2T. Third-largest economy globally. Japanese entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Japan | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | My Number (12 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | National Tax Agency | IRS |
| Currency | Japanese Yen (JPY, ~0.0067 USD) | USD |
| Population | 125,000,000 | 330M+ |

### Why Japanese Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Japan</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Japan passport number on Line 7b (where it asks for SSN). Use your Japan address on Line 4.</ProcessStep>
...
### Next Steps for Japanese Entrepreneurs
...
- Your US LLC income may be subject to both US and Japan taxes
- Check if a US-Japan tax treaty exists for reduced withholding
- Consult a CPA experienced with Japanese entrepreneurs in the US
...
[Apply for your EIN from Japan — $49](/apply/)
</Section>
