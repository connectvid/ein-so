...
description: "Jordanian entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Jordan using Form SS-4. ein.so handles it for $49."
...
faqs:
  - q: "Can Jordanian citizens get a US EIN?"
    a: "Yes. Jordanian citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Jordan passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Jordan?"
    a: "No. Jordanian applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Jordan?"
  ...
  - q: "Can I open a US bank account from Jordan?"
  ...
  - q: "What is the EIN equivalent in Jordan?"
    a: "The Jordan equivalent of a US EIN is the Tax Number (varies), issued by ISTD. Your Tax Number has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Jordanian entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Jordan passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Jordan</Label>

## Jordan's <Accent>US Business Footprint</Accent>

Jordan has a population of 11,000,000 and a GDP of $47B. Strategic Middle Eastern location. Jordanian entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Jordan | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | Tax Number (varies) | EIN (XX-XXXXXXX) |
| Tax Authority | ISTD | IRS |
| Currency | Jordanian Dinar (JOD, ~1.41 USD) | USD |
| Population | 11,000,000 | 330M+ |

### Why Jordanian Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Jordan</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Jordan passport number on Line 7b (where it asks for SSN). Use your Jordan address on Line 4.</ProcessStep>
...
### Next Steps for Jordanian Entrepreneurs
...
- Your US LLC income may be subject to both US and Jordan taxes
- Check if a US-Jordan tax treaty exists for reduced withholding
- Consult a CPA experienced with Jordanian entrepreneurs in the US
...
[Apply for your EIN from Jordan — $49](/apply/)
</Section>
