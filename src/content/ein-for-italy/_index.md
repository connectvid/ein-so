...
description: "Italian entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Italy using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Italy without an SSN or ITIN. ein.so handles the IRS fax filing process for Italian freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Italian citizens get a US EIN?"
    a: "Yes. Italian citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Italy passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Italy?"
    a: "No. Italian applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Italy?"
  ...
  - q: "What is the EIN equivalent in Italy?"
    a: "The Italy equivalent of a US EIN is the Codice Fiscale (16 characters), issued by Agenzia delle Entrate. Your Codice Fiscale has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Italian entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Italy passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Italy</Label>

## Italy's <Accent>US Business Footprint</Accent>

Italy has a population of 59,000,000 and a GDP of $2.0T. Strong fashion and manufacturing. Italian entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Italy | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | Codice Fiscale (16 characters) | EIN (XX-XXXXXXX) |
| Tax Authority | Agenzia delle Entrate | IRS |
| Currency | Euro (EUR, ~1.08 USD) | USD |
| Population | 59,000,000 | 330M+ |

### Why Italian Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Italy</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Italy passport number on Line 7b (where it asks for SSN). Use your Italy address on Line 4.</ProcessStep>
...
### Next Steps for Italian Entrepreneurs
...
- Your US LLC income may be subject to both US and Italy taxes
- Check if a US-Italy tax treaty exists for reduced withholding
- Consult a CPA experienced with Italian entrepreneurs in the US
