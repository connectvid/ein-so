...
description: "Iraqi entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Iraq using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Iraq without an SSN or ITIN. ein.so handles the IRS fax filing process for Iraqi freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Iraqi citizens get a US EIN?"
    a: "Yes. Iraqi citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Iraq passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Iraq?"
    a: "No. Iraqi applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Iraq?"
  ...
  - q: "Can I open a US bank account from Iraq?"
  ...
  - q: "What is the EIN equivalent in Iraq?"
    a: "The Iraq equivalent of a US EIN is the Tax ID (varies), issued by General Commission of Taxes. Your Tax ID has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Iraqi entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Iraq passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Iraq</Label>

## Iraq's <Accent>US Business Footprint</Accent>

Iraq has a population of 42,000,000 and a GDP of $264B. Oil economy, rebuilding business sector. Iraqi entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Iraq | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | Tax ID (varies) | EIN (XX-XXXXXXX) |
| Tax Authority | General Commission of Taxes | IRS |
| Currency | Iraqi Dinar (IQD, ~0.00076 USD) | USD |
| Population | 42,000,000 | 330M+ |

### Why Iraqi Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Iraq</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Iraq passport number on Line 7b (where it asks for SSN). Use your Iraq address on Line 4.</ProcessStep>
...
### Next Steps for Iraqi Entrepreneurs
...
- Your US LLC income may be subject to both US and Iraq taxes
- Check if a US-Iraq tax treaty exists for reduced withholding
- Consult a CPA experienced with Iraqi entrepreneurs in the US
...
[Apply for your EIN from Iraq — $49](/apply/)
</Section>
