...
description: "French entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from France using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from France without an SSN or ITIN. ein.so handles the IRS fax filing process for French freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can French citizens get a US EIN?"
    a: "Yes. French citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your France passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from France?"
    a: "No. French applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from France?"
  ...
  - q: "Can I open a US bank account from France?"
  ...
  - q: "What is the EIN equivalent in France?"
    a: "The France equivalent of a US EIN is the SIREN (9 digits), issued by DGFiP. Your SIREN has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**French entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your France passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>France</Label>

## France's <Accent>US Business Footprint</Accent>

France has a population of 68,000,000 and a GDP of $2.8T. Largest EU economy by purchasing power. French entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | France | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | SIREN (9 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | DGFiP | IRS |
| Currency | Euro (EUR, ~1.08 USD) | USD |
| Population | 68,000,000 | 330M+ |

### Why French Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From France</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your France passport number on Line 7b (where it asks for SSN). Use your France address on Line 4.</ProcessStep>
...
### Next Steps for French Entrepreneurs
...
- Your US LLC income may be subject to both US and France taxes
- Check if a US-France tax treaty exists for reduced withholding
- Consult a CPA experienced with French entrepreneurs in the US
