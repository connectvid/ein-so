...
description: "Moroccan entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Morocco using Form SS-4. ein.so handles it for $49."
...
faqs:
  - q: "Can Moroccan citizens get a US EIN?"
    a: "Yes. Moroccan citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Morocco passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Morocco?"
    a: "No. Moroccan applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Morocco?"
  ...
  - q: "Can I open a US bank account from Morocco?"
  ...
  - q: "What is the EIN equivalent in Morocco?"
    a: "The Morocco equivalent of a US EIN is the IF (8 digits), issued by DGI. Your IF has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Moroccan entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Morocco passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Morocco</Label>

## Morocco's <Accent>US Business Footprint</Accent>

Morocco has a population of 37,000,000 and a GDP of $134B. Gateway to African markets. Moroccan entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Morocco | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | IF (8 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | DGI | IRS |
| Currency | Moroccan Dirham (MAD, ~0.10 USD) | USD |
| Population | 37,000,000 | 330M+ |

### Why Moroccan Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Morocco</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Morocco passport number on Line 7b (where it asks for SSN). Use your Morocco address on Line 4.</ProcessStep>
...
### Next Steps for Moroccan Entrepreneurs
...
- Your US LLC income may be subject to both US and Morocco taxes
- Check if a US-Morocco tax treaty exists for reduced withholding
- Consult a CPA experienced with Moroccan entrepreneurs in the US
...
[Apply for your EIN from Morocco — $49](/apply/)
</Section>
