...
heroDescription: "Apply for your US EIN from Romania without an SSN or ITIN. ein.so handles the IRS fax filing process for Romanian freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Romanian citizens get a US EIN?"
    a: "Yes. Romanian citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Romania passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Romania?"
    a: "No. Romanian applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Romania?"
  ...
  - q: "Can I open a US bank account from Romania?"
  ...
  - q: "What is the EIN equivalent in Romania?"
    a: "The Romania equivalent of a US EIN is the CUI (varies), issued by ANAF. Your CUI has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Romanian entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Romania passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Romania</Label>

## Romania's <Accent>US Business Footprint</Accent>

Romania has a population of 19,000,000 and a GDP of $301B. EU member, growing tech sector. Romanian entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Romania | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | CUI (varies) | EIN (XX-XXXXXXX) |
| Tax Authority | ANAF | IRS |
| Currency | Romanian Leu (RON, ~0.22 USD) | USD |
| Population | 19,000,000 | 330M+ |

### Why Romanian Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Romania</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Romania passport number on Line 7b (where it asks for SSN). Use your Romania address on Line 4.</ProcessStep>
...
### Next Steps for Romanian Entrepreneurs
...
- Your US LLC income may be subject to both US and Romania taxes
- Check if a US-Romania tax treaty exists for reduced withholding
- Consult a CPA experienced with Romanian entrepreneurs in the US
...
[Apply for your EIN from Romania — $49](/apply/)
</Section>
