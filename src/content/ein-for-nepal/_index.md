...
description: "Nepalese entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Nepal using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Nepal without an SSN or ITIN. ein.so handles the IRS fax filing process for Nepalese freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Nepalese citizens get a US EIN?"
    a: "Yes. Nepalese citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Nepal passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Nepal?"
    a: "No. Nepalese applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Nepal?"
  ...
  - q: "Can I open a US bank account from Nepal?"
  ...
  - q: "What is the EIN equivalent in Nepal?"
    a: "The Nepal equivalent of a US EIN is the PAN (9 digits), issued by IRD. Your PAN has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Nepalese entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Nepal passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Nepal</Label>

## Nepal's <Accent>US Business Footprint</Accent>

Nepal has a population of 30,000,000 and a GDP of $40B. Growing freelancer community. Nepalese entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Nepal | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | PAN (9 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | IRD | IRS |
| Currency | Nepalese Rupee (NPR, ~0.0075 USD) | USD |
| Population | 30,000,000 | 330M+ |

### Why Nepalese Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Nepal</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Nepal passport number on Line 7b (where it asks for SSN). Use your Nepal address on Line 4.</ProcessStep>
...
### Next Steps for Nepalese Entrepreneurs
...
- Your US LLC income may be subject to both US and Nepal taxes
- Check if a US-Nepal tax treaty exists for reduced withholding
- Consult a CPA experienced with Nepalese entrepreneurs in the US
