...
description: "Irish entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Ireland using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Ireland without an SSN or ITIN. ein.so handles the IRS fax filing process for Irish freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Irish citizens get a US EIN?"
    a: "Yes. Irish citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Ireland passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Ireland?"
    a: "No. Irish applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Ireland?"
  ...
  - q: "Can I open a US bank account from Ireland?"
  ...
  - q: "What is the EIN equivalent in Ireland?"
    a: "The Ireland equivalent of a US EIN is the CRO Number (varies), issued by Revenue Commissioners. Your CRO Number has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Irish entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Ireland passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Ireland</Label>

## Ireland's <Accent>US Business Footprint</Accent>

Ireland has a population of 5,000,000 and a GDP of $529B. EU tech hub (Google, Apple, Meta). Irish entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Ireland | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | CRO Number (varies) | EIN (XX-XXXXXXX) |
| Tax Authority | Revenue Commissioners | IRS |
| Currency | Euro (EUR, ~1.08 USD) | USD |
| Population | 5,000,000 | 330M+ |

### Why Irish Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Ireland</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Ireland passport number on Line 7b (where it asks for SSN). Use your Ireland address on Line 4.</ProcessStep>
...
- Your US LLC income may be subject to both US and Ireland taxes
- Check if a US-Ireland tax treaty exists for reduced withholding
- Consult a CPA experienced with Irish entrepreneurs in the US
...
[Apply for your EIN from Ireland — $49](/apply/)
</Section>
