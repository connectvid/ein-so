...
description: "Turkish entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Turkey using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Turkey without an SSN or ITIN. ein.so handles the IRS fax filing process for Turkish freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Turkish citizens get a US EIN?"
    a: "Yes. Turkish citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Turkey passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Turkey?"
    a: "No. Turkish applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Turkey?"
  ...
  - q: "Can I open a US bank account from Turkey?"
  ...
  - q: "What is the EIN equivalent in Turkey?"
    a: "The Turkey equivalent of a US EIN is the Tax ID (10 digits), issued by Revenue Administration. Your Tax ID has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Turkish entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Turkey passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Turkey</Label>

## Turkey's <Accent>US Business Footprint</Accent>

Turkey has a population of 85,000,000 and a GDP of $906B. Large e-commerce market. Turkish entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Turkey | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | Tax ID (10 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | Revenue Administration | IRS |
| Currency | Turkish Lira (TRY, ~0.031 USD) | USD |
| Population | 85,000,000 | 330M+ |

### Why Turkish Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Turkey</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Turkey passport number on Line 7b (where it asks for SSN). Use your Turkey address on Line 4.</ProcessStep>
...
### Next Steps for Turkish Entrepreneurs
...
- Your US LLC income may be subject to both US and Turkey taxes
- Check if a US-Turkey tax treaty exists for reduced withholding
- Consult a CPA experienced with Turkish entrepreneurs in the US
...
[Apply for your EIN from Turkey — $49](/apply/)
</Section>
