...
description: "Australian entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Australia using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Australia without an SSN or ITIN. ein.so handles the IRS fax filing process for Australian freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Australian citizens get a US EIN?"
    a: "Yes. Australian citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Australia passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Australia?"
    a: "No. Australian applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Australia?"
  ...
  - q: "Can I open a US bank account from Australia?"
  ...
  - q: "What is the EIN equivalent in Australia?"
    a: "The Australia equivalent of a US EIN is the ABN (11 digits), issued by Australian Taxation Office. Your ABN has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Australian entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Australia passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Australia</Label>

## Australia's <Accent>US Business Footprint</Accent>

Australia has a population of 26,000,000 and a GDP of $1.7T. Large freelancer market on Upwork and Fiverr. Australian entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Australia | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | ABN (11 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | Australian Taxation Office | IRS |
| Currency | Australian Dollar (AUD, ~0.65 USD) | USD |
| Population | 26,000,000 | 330M+ |

### Why Australian Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Australia</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Australia passport number on Line 7b (where it asks for SSN). Use your Australia address on Line 4.</ProcessStep>
...
### Australia-Specific SS-4 Tips

| SS-4 Field | Australian Entry |
|-----------|-----------------|
| Line 1 (Legal name) | Your US LLC name |
| Line 4 (Address) | Your Australia address |
| Line 7a (Responsible party) | Your full name |
| Line 7b (SSN/ITIN) | Your Australia passport number |
| Line 10 (Reason) | Started new business |
| Line 16 (Country) | Australia |
</Section>
...
- Your US LLC income may be subject to both US and Australia taxes
- Check if a US-Australia tax treaty exists for reduced withholding
- Consult a CPA experienced with Australian entrepreneurs in the US
...
[Apply for your EIN from Australia — $49](/apply/)
</Section>
