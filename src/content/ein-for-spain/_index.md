...
description: "Spanish entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Spain using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Spain without an SSN or ITIN. ein.so handles the IRS fax filing process for Spanish freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Spanish citizens get a US EIN?"
    a: "Yes. Spanish citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Spain passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Spain?"
    a: "No. Spanish applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Spain?"
  ...
  - q: "Can I open a US bank account from Spain?"
  ...
  - q: "What is the EIN equivalent in Spain?"
    a: "The Spain equivalent of a US EIN is the NIF (9 characters), issued by AEAT. Your NIF has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Spanish entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Spain passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Spain</Label>

## Spain's <Accent>US Business Footprint</Accent>

Spain has a population of 47,000,000 and a GDP of $1.4T. Major European e-commerce market. Spanish entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Spain | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | NIF (9 characters) | EIN (XX-XXXXXXX) |
| Tax Authority | AEAT | IRS |
| Currency | Euro (EUR, ~1.08 USD) | USD |
| Population | 47,000,000 | 330M+ |

### Why Spanish Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Spain</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Spain passport number on Line 7b (where it asks for SSN). Use your Spain address on Line 4.</ProcessStep>
...
### Next Steps for Spanish Entrepreneurs
...
- Your US LLC income may be subject to both US and Spain taxes
- Check if a US-Spain tax treaty exists for reduced withholding
- Consult a CPA experienced with Spanish entrepreneurs in the US
...
[Apply for your EIN from Spain — $49](/apply/)
</Section>
