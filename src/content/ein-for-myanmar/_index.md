...
description: "Myanmar entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Myanmar using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Myanmar without an SSN or ITIN. ein.so handles the IRS fax filing process for Myanmar freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Myanmar citizens get a US EIN?"
    a: "Yes. Myanmar citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Myanmar passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Myanmar?"
    a: "No. Myanmar applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Myanmar?"
  ...
  - q: "What is the EIN equivalent in Myanmar?"
    a: "The Myanmar equivalent of a US EIN is the TIN (varies), issued by IRD. Your TIN has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Myanmar entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Myanmar passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Myanmar</Label>

## Myanmar's <Accent>US Business Footprint</Accent>

Myanmar has a population of 54,000,000 and a GDP of $65B. Emerging market. Myanmar entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Myanmar | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | TIN (varies) | EIN (XX-XXXXXXX) |
| Tax Authority | IRD | IRS |
| Currency | Myanmar Kyat (MMK, ~0.00048 USD) | USD |
| Population | 54,000,000 | 330M+ |

### Why Myanmar Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Myanmar</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Myanmar passport number on Line 7b (where it asks for SSN). Use your Myanmar address on Line 4.</ProcessStep>
...
### Next Steps for Myanmar Entrepreneurs
...
- Your US LLC income may be subject to both US and Myanmar taxes
- Check if a US-Myanmar tax treaty exists for reduced withholding
- Consult a CPA experienced with Myanmar entrepreneurs in the US
