...
description: "Cambodian entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Cambodia using Form SS-4. ein.so handles it for $49."
...
faqs:
  - q: "Can Cambodian citizens get a US EIN?"
    a: "Yes. Cambodian citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Cambodia passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Cambodia?"
    a: "No. Cambodian applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Cambodia?"
  ...
  - q: "Can I open a US bank account from Cambodia?"
  ...
  - q: "What is the EIN equivalent in Cambodia?"
    a: "The Cambodia equivalent of a US EIN is the TIN (9 digits), issued by GDT. Your TIN has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Cambodian entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Cambodia passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Cambodia</Label>

## Cambodia's <Accent>US Business Footprint</Accent>

Cambodia has a population of 17,000,000 and a GDP of $30B. Growing garment and tech sectors. Cambodian entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.
...
| Population | 17,000,000 | 330M+ |

### Why Cambodian Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Cambodia</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Cambodia passport number on Line 7b (where it asks for SSN). Use your Cambodia address on Line 4.</ProcessStep>
...
- Your US LLC income may be subject to both US and Cambodia taxes
- Check if a US-Cambodia tax treaty exists for reduced withholding
- Consult a CPA experienced with Cambodian entrepreneurs in the US
