...
description: "Israeli entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Israel using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Israel without an SSN or ITIN. ein.so handles the IRS fax filing process for Israeli freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Israeli citizens get a US EIN?"
    a: "Yes. Israeli citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Israel passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Israel?"
    a: "No. Israeli applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Israel?"
  ...
  - q: "Can I open a US bank account from Israel?"
  ...
  - q: "What is the EIN equivalent in Israel?"
    a: "The Israel equivalent of a US EIN is the Company Number (9 digits), issued by Israel Tax Authority. Your Company Number has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Israeli entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Israel passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Israel</Label>

## Israel's <Accent>US Business Footprint</Accent>

Israel has a population of 10,000,000 and a GDP of $525B. Startup Nation — highest VC per capita. Israeli entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Israel | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | Company Number (9 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | Israel Tax Authority | IRS |
| Currency | Israeli Shekel (ILS, ~0.28 USD) | USD |
| Population | 10,000,000 | 330M+ |

### Why Israeli Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Israel</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Israel passport number on Line 7b (where it asks for SSN). Use your Israel address on Line 4.</ProcessStep>
...
### Next Steps for Israeli Entrepreneurs
...
- Your US LLC income may be subject to both US and Israel taxes
- Check if a US-Israel tax treaty exists for reduced withholding
- Consult a CPA experienced with Israeli entrepreneurs in the US
...
[Apply for your EIN from Israel — $49](/apply/)
</Section>
