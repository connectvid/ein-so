...
description: "Russian entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Russia using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Russia without an SSN or ITIN. ein.so handles the IRS fax filing process for Russian freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Russian citizens get a US EIN?"
    a: "Yes. Russian citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Russia passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Russia?"
    a: "No. Russian applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Russia?"
  ...
  - q: "Can I open a US bank account from Russia?"
  ...
  - q: "What is the EIN equivalent in Russia?"
    a: "The Russia equivalent of a US EIN is the INN (10-12 digits), issued by Federal Tax Service. Your INN has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Russian entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Russia passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Russia</Label>

## Russia's <Accent>US Business Footprint</Accent>

Russia has a population of 144,000,000 and a GDP of $1.8T. Note: sanctions may affect some services. Russian entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Russia | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | INN (10-12 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | Federal Tax Service | IRS |
| Currency | Russian Ruble (RUB, ~0.011 USD) | USD |
| Population | 144,000,000 | 330M+ |

### Why Russian Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Russia</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Russia passport number on Line 7b (where it asks for SSN). Use your Russia address on Line 4.</ProcessStep>
...
### Next Steps for Russian Entrepreneurs
...
- Your US LLC income may be subject to both US and Russia taxes
- Check if a US-Russia tax treaty exists for reduced withholding
- Consult a CPA experienced with Russian entrepreneurs in the US
...
[Apply for your EIN from Russia — $49](/apply/)
</Section>
