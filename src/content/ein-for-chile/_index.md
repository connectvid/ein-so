...
description: "Chilean entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Chile using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Chile without an SSN or ITIN. ein.so handles the IRS fax filing process for Chilean freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Chilean citizens get a US EIN?"
    a: "Yes. Chilean citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Chile passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Chile?"
    a: "No. Chilean applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Chile?"
  ...
  - q: "Can I open a US bank account from Chile?"
  ...
  - q: "What is the EIN equivalent in Chile?"
    a: "The Chile equivalent of a US EIN is the RUT (8-9 digits), issued by SII. Your RUT has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Chilean entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Chile passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Chile</Label>

## Chile's <Accent>US Business Footprint</Accent>

Chile has a population of 19,000,000 and a GDP of $301B. Most stable Latin American economy. Chilean entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.
...
### Why Chilean Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Chile</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Chile passport number on Line 7b (where it asks for SSN). Use your Chile address on Line 4.</ProcessStep>
...
### Next Steps for Chilean Entrepreneurs
...
- Your US LLC income may be subject to both US and Chile taxes
- Check if a US-Chile tax treaty exists for reduced withholding
- Consult a CPA experienced with Chilean entrepreneurs in the US
...
[Apply for your EIN from Chile — $49](/apply/)
</Section>
