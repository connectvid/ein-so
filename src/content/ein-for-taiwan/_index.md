...
description: "Taiwanese entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Taiwan using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Taiwan without an SSN or ITIN. ein.so handles the IRS fax filing process for Taiwanese freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Taiwanese citizens get a US EIN?"
    a: "Yes. Taiwanese citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Taiwan passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Taiwan?"
    a: "No. Taiwanese applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Taiwan?"
  ...
  - q: "Can I open a US bank account from Taiwan?"
  ...
  - q: "What is the EIN equivalent in Taiwan?"
    a: "The Taiwan equivalent of a US EIN is the UBN (8 digits), issued by National Taxation Bureau. Your UBN has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Taiwanese entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Taiwan passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Taiwan</Label>

## Taiwan's <Accent>US Business Footprint</Accent>

Taiwan has a population of 24,000,000 and a GDP of $790B. Semiconductor industry hub. Taiwanese entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Taiwan | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | UBN (8 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | National Taxation Bureau | IRS |
| Currency | New Taiwan Dollar (TWD, ~0.032 USD) | USD |
| Population | 24,000,000 | 330M+ |

### Why Taiwanese Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Taiwan</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Taiwan passport number on Line 7b (where it asks for SSN). Use your Taiwan address on Line 4.</ProcessStep>
...
### Next Steps for Taiwanese Entrepreneurs
...
- Your US LLC income may be subject to both US and Taiwan taxes
- Check if a US-Taiwan tax treaty exists for reduced withholding
- Consult a CPA experienced with Taiwanese entrepreneurs in the US
...
[Apply for your EIN from Taiwan — $49](/apply/)
</Section>
