...
description: "Peruvian entrepreneurs can get a US EIN without an SSN or ITIN. Learn how to apply for an EIN from Peru using Form SS-4. ein.so handles it for $49."
...
heroDescription: "Apply for your US EIN from Peru without an SSN or ITIN. ein.so handles the IRS fax filing process for Peruvian freelancers, Amazon sellers, and business owners. $49 Standard. $97 Express."
...
faqs:
  - q: "Can Peruvian citizens get a US EIN?"
    a: "Yes. Peruvian citizens can apply for a US EIN by faxing Form SS-4 to the IRS. No SSN required. Use your Peru passport number. ein.so handles the process for $49."
  - q: "Do I need an SSN to get an EIN from Peru?"
    a: "No. Peruvian applicants use their passport number instead of an SSN on Form SS-4 Line 7b. The IRS online tool requires SSN, so you must use the fax method."
  - q: "How long does it take from Peru?"
  ...
  - q: "Can I open a US bank account from Peru?"
  ...
  - q: "What is the EIN equivalent in Peru?"
    a: "The Peru equivalent of a US EIN is the RUC (11 digits), issued by SUNAT. Your RUC has no standing in the US — you need a separate EIN for US business."
---

<Section>
<Capsule>**Peruvian entrepreneurs can get a US EIN by submitting IRS Form SS-4 by fax. Your Peru passport number replaces the SSN requirement.** The IRS online tool is blocked for applicants without an SSN, so the fax method is your path. ein.so prepares your SS-4, faxes it to the IRS, and delivers your EIN. Standard $49. Express $97.</Capsule>
</Section>

<Section surface>
<Label>Peru</Label>

## Peru's <Accent>US Business Footprint</Accent>

Peru has a population of 34,000,000 and a GDP of $223B. Growing Latin American market. Peruvian entrepreneurs expanding into the US market need an EIN to operate their US business entity legally.

| Factor | Peru | United States |
|--------|--------|---------------|
| Business Entity | Local structures | LLC / Corporation |
| Tax ID | RUC (11 digits) | EIN (XX-XXXXXXX) |
| Tax Authority | SUNAT | IRS |
| Currency | Peruvian Sol (PEN, ~0.27 USD) | USD |
| Population | 34,000,000 | 330M+ |

### Why Peruvian Entrepreneurs Need a US EIN
...
## How to Get an EIN <Accent>From Peru</Accent>
...
<ProcessStep step="2" title="Complete Form SS-4">Fill out [IRS Form SS-4](/ss4-form-guide/) with your LLC information. Use your Peru passport number on Line 7b (where it asks for SSN). Use your Peru address on Line 4.</ProcessStep>
...
### Next Steps for Peruvian Entrepreneurs
...
- Your US LLC income may be subject to both US and Peru taxes
- Check if a US-Peru tax treaty exists for reduced withholding
- Consult a CPA experienced with Peruvian entrepreneurs in the US
...
[Apply for your EIN from Peru — $49](/apply/)
</Section>
