...
heroDescription: "Both are 9-digit identification numbers issued by the US government, but they serve fundamentally different purposes. An EIN identifies your business. An SSN identifies you as an individual. Here is the complete comparison."
ctaTitle: "Get Your EIN Without an SSN"
ctaSubtitle: "$49. No SSN required. No paperwork. We handle the IRS fax process for you."
breadcrumbs:
  - name: "Home"
    url: "/"
  - name: "EIN vs ITIN"
...
## EIN vs SSN: Complete <Accent>Comparison Table</Accent>
...
## When You Need EIN vs SSN vs <Accent>Both</Accent>
...
Non-US residents cannot obtain an SSN unless they have authorization to work in the United States. However, they can still form a US business and get an EIN without an SSN. See our guide on [how to get an EIN without an SSN](/ein-without-ssn/).

</Section>

<Section>

## Can You Use an EIN Instead of <Accent>an SSN?</Accent>
...
For more on how EINs compare with other personal tax IDs, read our [EIN vs ITIN comparison guide](/ein-vs-itin/).

</Section>

<Section surface>

## When Do You Need Both an <Accent>EIN and an SSN?</Accent>

<FeatureCards>
<FeatureCard title="US Resident Starting a Business" icon="building">If you are a US citizen or permanent resident forming an LLC, corporation, or partnership, you need your SSN to apply for the EIN online. Once you have the EIN, you use the EIN for all business activities and your SSN for personal tax filing. Both numbers remain active permanently.</FeatureCard>
<FeatureCard title="Sole Proprietor Hiring Employees" icon="dollar">A sole proprietor with no employees can use their SSN for business taxes. The moment you hire your first employee, you must get an EIN. From that point, you use the EIN for payroll taxes (Forms 940 and 941) and your SSN for personal income taxes (Form 1040).</FeatureCard>
<FeatureCard title="Multi-Member LLC or Partnership" icon="document">Any business with more than one owner must have an EIN. Each owner uses their personal SSN on their individual tax return (Schedule K-1), while the business files its partnership return (Form 1065) under the EIN. There is no option to use an SSN for a multi-member entity.</FeatureCard>
<FeatureCard title="Corporation Owner" icon="shield">Every corporation (S-Corp or C-Corp) requires an EIN regardless of how many shareholders it has. As a shareholder, you use your SSN for personal tax filing. The corporation uses the EIN for corporate tax returns, payroll, and all business transactions.</FeatureCard>
</FeatureCards>
...
## Can Non-Residents Without an SSN Get an <Accent>EIN?</Accent>
...
## EIN vs SSN: Why Privacy <Accent>Matters</Accent>
